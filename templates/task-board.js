...
function openEkipDuzenle(ekipId) {
  ...
  content.innerHTML = `
    <div class="gd-header">
      ...
      <button class="ef-kapat" onclick="closeModal('ekip-detay-modal')" title="Kapat"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
    </div>
